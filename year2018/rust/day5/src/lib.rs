...
mod test {
    ...
    fn test_part2() {
        let input =
            std::fs::read_to_string("../../data/day5_part2_data.txt").expect("couldn't open file");
    ...
    fn test_part1_with_write_of_part2() {
        ...
        let input =
            std::fs::read_to_string("../../data/day5_data.txt").expect("couldn't open file");
    ...
    fn test_simple_write() {
        ...
        polymer.write_to_file(&path);
        let output = std::fs::read_to_string(&path).expect("couldn't open file");
